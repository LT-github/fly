...
//			"sum(ifnull(total_money,0)) betResult " +
...
//			"sum(case when t.discriminator='AuditFinance' then t.money end) as AuditFinance," +
//			"sum(case when t.discriminator='BetsFinance'  then t.money end) as BetsFinance," +
//			"sum(case when t.discriminator='ReturnPointFinance'  then t.money end) as ReturnPointFinance " +
